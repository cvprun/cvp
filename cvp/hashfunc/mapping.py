...
HASH_MAPPING: Final[MappingProxyType[HashFunction, Callable]] = MappingProxyType(
    {
...
def compute_hash(method: HashFunction, data: bytes) -> str:
    return HASH_MAPPING[method](data).hexdigest()
