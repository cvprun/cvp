...
CVP_HUB_LOGGER_NAME: Final[str] = f"{CVP_LOGGER_NAME}.hub"
...
CVP_SCHEDULER_LOGGER_NAME: Final[str] = f"{CVP_LOGGER_NAME}.scheduler"
CVP_SERVICE_LOGGER_NAME: Final[str] = f"{CVP_LOGGER_NAME}.service"
CVP_WATCHDOG_LOGGER_NAME: Final[str] = f"{CVP_LOGGER_NAME}.watchdog"
...
CVP_MODBUS_LOGGER_NAME: Final[str] = f"{CVP_LOGGER_NAME}.modbus"
CVP_WS_LOGGER_NAME: Final[str] = f"{CVP_LOGGER_NAME}.ws"
