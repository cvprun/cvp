...
def create_onvif_tab_types() -> Sequence[Type[BaseOnvifTab]]:
    from cvp.apps.player.modes.vms.onvif.apis import OnvifApisTab
    from cvp.apps.player.modes.vms.onvif.auth import OnvifAuthTab
    from cvp.apps.player.modes.vms.onvif.client import OnvifClientTab
    from cvp.apps.player.modes.vms.onvif.info import OnvifInfoTab
