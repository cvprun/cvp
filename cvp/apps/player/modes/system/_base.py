...
@runtime_checkable
class SystemMenuProtocol(Protocol):
    __cvp_menu_name__: str
    __cvp_menu_icon__: str
...
class BaseSystem(SystemInterface, SystemMenuProtocol, ABC):
    def __init__(self, context: Context):
        assert isinstance(self, SystemMenuProtocol)
