...
class ProgrammablePipelineRenderer(BaseRenderer):
    ...
    def _create_device_objects(self):
        ...
        GL.glVertexAttribPointer(
            ...
            GL.GL_FALSE,
            imgui.VERTEX_SIZE,
            c_void_p(imgui.VERTEX_BUFFER_POS_OFFSET),
        )
        GL.glVertexAttribPointer(
            ...
            GL.GL_FALSE,
            imgui.VERTEX_SIZE,
            c_void_p(imgui.VERTEX_BUFFER_UV_OFFSET),
        )
        GL.glVertexAttribPointer(
            ...
            GL.GL_TRUE,
            imgui.VERTEX_SIZE,
            c_void_p(imgui.VERTEX_BUFFER_COL_OFFSET),
        )
    ...
    def render(self, draw_data: imgui.ImDrawData) -> None:
        ...
        ortho_projection = (c_float * 16)(  # noqa
            2.0 / display_width,
            0.0,
            0.0,
            0.0,
        ...
        for commands in draw_data.cmd_lists:
            ...
            GL.glBufferData(
                ...
                c_void_p(commands.vtx_buffer.data_address()),
                GL.GL_STREAM_DRAW,
            )
            ...
            GL.glBufferData(
                ...
                c_void_p(commands.idx_buffer.data_address()),
                GL.GL_STREAM_DRAW,
            )
