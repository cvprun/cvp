...
class FindTestCase(TestCase):
    ...
    def test_find_jobs_in_time_range(self):
        ...
        actual1 = find_jobs_in_time_range(self.states, begin1, end1, sort=True)
        self.assertEqual(expect1, actual1)
        ...
        actual2 = find_jobs_in_time_range(self.states, begin2, end2, sort=True)
        self.assertEqual(expect2, actual2)
